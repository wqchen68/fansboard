												...
												<div style="float:left;padding:5px;height:60px;width:75%">
													...
													<div style="float:right">
                                                        ...
                                                        if (strlen($realtime[0]->trend)==0){
                                                            ...
                                                            echo '<span class="todaybo-eff0" style="color:gold">EFF +'.number_format($realtime[0]->trend,1).'</span>';
                                                        }
                                                        ?>
													</div>
												</div>
												...
												<div style="float:left;padding:5px;height:60px;width:75%">
													...
													<div style="float:right">
                                                        ...
                                                        if (strlen($realtime[0]->trend)==0){
                                                            ...
                                                            echo '<span class="todaybo-eff1" style="color:gold">EFF +'.number_format($realtime[1]->trend,1).'</span>';
                                                        }
                                                        ?>
													</div>
												</div>
