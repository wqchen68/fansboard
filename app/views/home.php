											...
											<div class="prcard" style="background-color:rgba(0,0,0,0.6)">
												...
												<div style="float:left;padding:5px;height:60px;width:75%">
													...
													<div style="float:right">
														...
														<span class="todaybo-eff0" style="color:gold"><?='EFF +'.number_format($realtime[0]->trend,1)?></span>
													</div>
												</div>
											...
											<div class="prcard" style="background-color:rgba(0,0,0,0.6)">
												...
												<div style="float:left;padding:5px;height:60px;width:75%">
													...
													<div style="float:right">
														...
														<span class="todaybo-eff1" style="color:gold"><?='EFF +'.number_format($realtime[1]->trend,1)?></span>
													</div>
												</div>
												<div style="height:0;clear:both"></div>
											</div>
